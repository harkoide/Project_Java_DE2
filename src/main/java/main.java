...
public class main {
    public static void main(String[] args) throws FileNotFoundException, SQLException {
        ...
        ArrayList<String> good_file = CsvOperation.scan_repositories(directory_In, directory_Out, directory_Error);

        ArrayList<String[]> line_csv_to_process = CsvOperation.read_csv(good_file, directory_In.getPath());
